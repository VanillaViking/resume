...
\fancyfoot{}
\fancyfoot[L]{\emph{Referees available on request}}
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      {University of Technology Sydney}{Feb 2021 -- Dec 2025}
      {Bachelor of Software Engineering (Honours) 79 WAM}{Ultimo, NSW}
      \resumeItemListStart
...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Full-Stack Software Developer}{Nov 2022 -- Jul 2023}
      {Gecko.rent}{Ultimo, NSW}
      \resumeItemListStart
        \resumeItem{Implemented inventory tracking, product addons, review systems and more with MongoDB, GraphQL \& NextJS.}
        \resumeItem{Retained customers by decreasing load times by \textbf{more than 90 seconds} by using static paths and rendering.}
...
%-------------------------------------------
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Established reproducible builds and caching through a Nix CI. \textbf{saved up to 10 minutes} on Rust builds.}
    \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Assisted students on practical projects, providing technical and design practice counsel.}
        \resumeItem{\textbf{Evaluated 160 students' performance} based on technical and practical proficiency.}
      \resumeItemListEnd
  \resumeSubHeadingListEnd
